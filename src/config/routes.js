const routes = {
    ...
    DeTaiKhoaLuanThamGia: '/DeTaiKhoaLuan/DeTaiKhoaLuanThamGia',
    NhomDeTaiKhoaLuan: '/NhomDeTaiKhoaLuan',
    DeTaiKhoaLuan: '/DeTaiNKhoaLuan',
    ThucTap: '/ThucTap',
    ...
    DeTaiKhoaLuanThamGia_Department: '/Department/NghiepVu/DeTaiKhoaLuan/DeTaiKhoaLuanThamGia',
    DeTaiKhoaLuan_Department: '/Department/NghiepVu/DeTaiKhoaLuan',
    ThucTap_Department: '/Department/NghiepVu/ThucTap',
    NhomDeTaiNCKH_Department: '/Department/NghiepVu/NhomDeTaiNCKH',
    NhomDeTaiKhoaLuan_Department: '/Department/NghiepVu/NhomDeTaiKhoaLuan',
